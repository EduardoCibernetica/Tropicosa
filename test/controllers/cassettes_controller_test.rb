...
class CassettesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cassette" do
    assert_difference('Cassette.count') do
      post cassettes_url, params: { cassette: { Ano: @cassette.Ano, Autor: @cassette.Autor, Disquetera: @cassette.Disquetera, Precio: @cassette.Precio, Titulo: @cassette.Titulo } }
    end
  ...
  test "should update cassette" do
    patch cassette_url(@cassette), params: { cassette: { Ano: @cassette.Ano, Autor: @cassette.Autor, Disquetera: @cassette.Disquetera, Precio: @cassette.Precio, Titulo: @cassette.Titulo } }
